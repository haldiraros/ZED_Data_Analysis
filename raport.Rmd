...
```{r atoms_predict, results="asis",  message=FALSE, fig.width=7,fig.height=7, cache=TRUE }
...
```{r elec_predict,results="asis", message=FALSE, fig.width=7,fig.height=7 , cache=TRUE}
